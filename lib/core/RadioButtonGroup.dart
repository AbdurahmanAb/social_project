 ...
 final Color selectedIconColor;
  ...
  RadioButtonGroup copyWith(
    ...
    return RadioButtonGroup(
      ...
      selectedBorderSide: selectedBorderSide ?? this.selectedBorderSide,
      betweenMultiLines: betweenMultiLines ?? this.betweenMultiLines,
      unselectEnabled: unselectEnabled ?? this.unselectEnabled,
    ...
    for (RadioOption radioOption in widget.options ) {
      radioButtons.add(Padding(
        ...
        child: _RadioButton(
          ...
          buttonsEnabled: widget.buttonsEnabled,
...
class _RadioButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _BasicButton(
      ...
      color: isSelected ? colorSelected?.withOpacity(buttonsEnabled ? 1 : 0.4) : colorMain.withOpacity(buttonsEnabled ? 1 : 0.4),
      borderSide: borderSide?.copyWith(color: borderSide?.color.withOpacity(buttonsEnabled ? 1 : 0.5)),
    );
  }
}
